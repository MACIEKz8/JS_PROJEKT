...
class interfejs:
    ...
    def gui(self):
        ...
        dziesiec_zl = Button(root, text='10 zł', height=5, width=15, activebackground="#404040", bg=color,
                        command=lambda: [p.timer.dodajMonete(p.Moneta(10), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        dziesiec_zl.grid(row=2, column = 0)
        dwadziescia_zl = Button(root, text='20 zł', height=5, width=15, activebackground="#404040", bg=color,
                             command=lambda: [p.timer.dodajMonete(p.Moneta(20), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        ...
        piecdziesiat_zl = Button(root, text='50 zł', height=5, width=15, activebackground="#404040", bg=color,
                             command=lambda: [p.timer.dodajMonete(p.Moneta(50), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        piecdziesiat_zl.grid(row=2, column=2)

        zlotowka = Button(root, text='1 zł', height=5, width=15, activebackground="#404040", bg=color,
                             command=lambda: [p.timer.dodajMonete(p.Moneta(1), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        zlotowka.grid(row=3, column=0)
        dwa_zl = Button(root, text='2 zł', height=5, width=15, activebackground="#404040", bg=color,
                            command=lambda: [p.timer.dodajMonete(p.Moneta(2), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        dwa_zl.grid(row=3, column=1)
        piec_zl = Button(root, text='5 zł', height=5, width=15, activebackground="#404040", bg=color,
                             command=lambda: [p.timer.dodajMonete(p.Moneta(5), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        piec_zl.grid(row=3, column=2)

        dziesiec_gr = Button(root, text='0.10 zł', height=5, width=15, activebackground="#404040", bg=color,
                             command=lambda: [p.timer.dodajMonete(p.Moneta(0.10), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        ...
        dwadziescia_gr = Button(root, text='0.20 zł', height=5, width=15, activebackground="#404040", bg=color,
                                command=lambda: [p.timer.dodajMonete(p.Moneta(0.20), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        ...
        piecdziesiat_gr = Button(root, text='0.50 zł', height=5, width=15, activebackground="#404040", bg=color,
                                 command=lambda: [p.timer.dodajMonete(p.Moneta(0.50), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        piecdziesiat_gr.grid(row=4, column=2)

        grosz = Button(root, text='0.01 zł', height=5, width=15, activebackground="#404040", bg=color,
                        command=lambda: [p.timer.dodajMonete(p.Moneta(0.01), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        grosz.grid(row=5, column = 0)
        dwa_grosze = Button(root, text='0.02 zł', height=5, width=15, activebackground="#404040", bg=color,
                        command=lambda: [p.timer.dodajMonete(p.Moneta(0.02), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        dwa_grosze.grid(row=5, column=1)
        piec_groszy = Button(root, text='0.05 zł', height=5, width=15, activebackground="#404040", bg=color,
                        command=lambda: [p.timer.dodajMonete(p.Moneta(0.05), int(ilosc_monet.get())), self.wyswietlBudget(p.timer.budget(), wrzucono), self.wyswietlCzas(p.czasFormat(p.timer.aktualizujCzas()), d4)])
        ...
        zmien_date= Button(root, text="Zmień aktualną datę", height=1, width=15, bg="#5e5d5d", command=lambda: self.wyswietlCzas(p.timer.nowy_czas(nowa_data.get()), d2))
        ...
        d4 = Label(root, text=p.czasFormat(p.timer.aktualizujCzas()), bg="#404040",
                   foreground="#FFFFFF")
        ...
        wrzucono = Label(root, text=p.timer.budget(), bg="#404040", foreground="#FFFFFF")
